...
## 2. Installing Scala 3

## 3. Installing sbt

## 4. Installing Metals for VS Code
...
## 2. Creating a Scala file
Scala files have the `.scala` extension and are compiled when we run the project.

## 3. Opening our project in VS Code
...
## 3. Compiling and running a Scala project
If we have out `.scala` file, we can compile it and run it using sbt:
