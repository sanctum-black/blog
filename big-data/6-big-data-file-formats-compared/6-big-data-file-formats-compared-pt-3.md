...
We will then conclude with this series by reviewing specific use-cases for each one of the formats involved, as well as discuss some recommendations...

## Table of Contents
1. Side-by-Side Comparison & Performance Tests
2. Use Cases
3. Conclusions
4. References
