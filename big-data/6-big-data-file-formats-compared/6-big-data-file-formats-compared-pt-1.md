...
- [Writing With Python]()
	1. [CSV]()
		...
		3. [Using pandas.DataFrame.to_csv()]()
	2. [TXT]()
		1. [Using numpy.savetext()]()
		2. [Using pandas.DataFrame.to_csv()]()
	3. [Feather]()
		1. [Using pandas.DataFrame.to_feather()]()
	4. [Parquet]()
		1. [Using pandas.DataFrame.to_parquet() without partitioning]()
		2. [Using pandas.DataFrame.to_parquet() with a single partition]()
		3. [Using pandas.DataFrame.to_parquet() with multiple partitions]()
	5. [Avro]()
		1. [Using fastavro Python file handler]()
	6. [Pickle]()
